    ...
    <Container maxWidth="lg" display="flex" justifyContent="space-between">
      <Box className="flex flex-col lg:flex-row w-full gap-x-10 items-center justify-center bg-white p-4">
        ...
        <Box className="bg-white shadow-lg rounded-lg p-8 w-full lg:w-1/2">
          ...
          <Box className="mt-6">
            <Button className="!text-white !bg-gradient-to-r from-gray-600 to-gray-800 py-3 px-4 rounded-lg font-medium hover:from-gray-500 hover:to-gray-600 transform hover:scale-105 transition-all duration-300 shadow-md hover:shadow-lg px-6 py-2 rounded shadow">
              Send Message
            </Button>
          </Box>
        </Box>
